...
<title>SchoolTools : Staff Info</title>
...
<table id="companies" class="display">
	...
	<tbody>
		...
		<tr class="odd">
			<td><c:out value="${student.staff_name}"></c:out></td>
			<td><c:out value="${student.emp_no}"></c:out></td>
			<td><c:out value="${student.date_of_join}"></c:out></td>
			<td><c:out value="${student.department}"></c:out></td>
			<td><c:out value="${student.designation}"></c:out></td>
			<td>
