...
<%@page import="java.util.ArrayList,com.school.dto.*,com.school.domain.*,java.util.Date"%>
<%@include file="include.jsp"%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>SchoolTools : Student List for Marks Reports</title>
...
<div class="container">
<br><h1>Student List for Marks Reports</h1><br>
...
<table id="companies" class="display">
	...
	<tbody>
		...
		<tr class="odd">
			<td><a href="marksheetentryview.html?user=${user}&username=${username}&standard_id=${student.standard_id}&dob=${student.date_of_birth}&name=${student.first_name}&Rollno=${student.roll_no}&standard=${student.standard_name}"><c:out value="${student.first_name}"></c:out></a></td>
